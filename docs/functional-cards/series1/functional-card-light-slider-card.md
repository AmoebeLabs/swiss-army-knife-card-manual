...
-   :sak-sak-logo:{ .lg .middle } __Light *"On"*__
    ...
    ![Swiss Army Knife Functional Card Light with Slider D06 Dark On](../../assets/screenshots/sak-functional-card-12-light-slider-theme-d06-dark-on.png#only-dark){width="300"}
</div>
