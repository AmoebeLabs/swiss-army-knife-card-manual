...
![Swiss Army Knife Functional Card Sensor1 D06 Light](../../assets/screenshots/sak-functional-card-12-sensor1ab-theme-d06-light-variants.png#only-light){width="600"}
<br>![Swiss Army Knife Functional Card Sensor1 D06 Dark](../../assets/screenshots/sak-functional-card-12-sensor1ab-theme-d06-dark-variants.png#only-dark){width="600"}
