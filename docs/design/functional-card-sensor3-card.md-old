---
template: main.html
title: "Functional Cards: Sensor Card #3"
description: "Example of functional card, sensor card #3"
hideno:
  toc
tags:
  - Design
...
![Swiss Army Knife Functional Card Sensor3 D06 Light]( ../assets/screenshots/sak-functional-card-12-sensor3-theme-d06-light.png){width="300"}
<br>![Swiss Army Knife Functional Card Sensor3 D06 Dark]( ../assets/screenshots/sak-functional-card-12-sensor3-theme-d06-dark.png){width="300"}
                  ...
                  - type: circle
                    ...
                    colorstops:
                      ...
                      colors:
                        ...
                        0.66: var(--brand-google-yellow)
                        1.32: var(--brand-google-red)
                    styles:
                      circle:
                        stroke: none
                        opacity: 0.25
