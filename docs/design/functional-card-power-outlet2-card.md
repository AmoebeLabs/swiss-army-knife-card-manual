...
=== "3/1 Card - Kitchen"
    <div style="max-width:800px;" markdown>![Swiss Army Knife Functional Card Power Outlet D06 Light On]</div>
...
=== "4/1 Card - Kitchen Power"
    <div style="max-width:800px;" markdown>![Swiss Army Knife Functional Card Power Outlet2 D06 Light On]</div>
    This card shows the power and the state of the switch, but you cannot toggle the switch.
...
=== "4/1 Card - Kitchen Power \#2"
    <div style="max-width:800px;" markdown>![Swiss Army Knife Functional Card Power Outlet2 D06 Light On]</div>
    This card shows the power, the state of the switch and 24 hour history. And you can toggle the switch!
