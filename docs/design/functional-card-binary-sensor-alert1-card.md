...
=== "First 3/1 Card - Movement"
    ...
    ??? example "Animated, state dependent Alert Icon "
        ```yaml linenums="1"
                  - toolset: alert-icon
                    position:
                      cx: 40
    ...
    ??? example "Battery with icon, segmented arc and state"
        ```yaml linenums="1"
    ...
    ??? example "Linkquality with icon, segmented arc and state"
        ```yaml linenums="1"
...
=== "4/1 Card - Livingroom \#2"
    ...
    ??? example "Animated, state dependent Alert Icon on top of Circle"
        ```yaml linenums="1"
                      - toolset: alert-icon
                    position:
                      cx: 40
